(function(window, document, $, undefined) {
	...
	window.SaveHandler = new function() {
		...
		var Format = new function() {
			...
			// The current Save Format (Up-to-date up to version 2.0.12.0)
			{ this.format = [																				// Description
				...
				{ 'format': 'Object', 'key': 'options', 'members': [										// The list of options
					...
					{ 'format': 'Int8', 'key': 'enable_extended_lists' },				// Option: Ruby Warning
				...
				{ 'format': 'Object', 'key': 'tutorialThings', 'members': [										// The list of options
					{ 'format': 'Int8', 'key': 'len' },														// Option: Currently active tab
					{ 'format': 'Int8', 'key': 'thing1' },														// Option: Number notation (0: Short Numbers, 1: Scientific Notation, 2: Engineering Notation)
					{ 'format': 'Int8', 'key': 'thing2' },												// Option: Disable Cloud Restore Warning at Setup
					{ 'format': 'Int8', 'key': 'thing3' },											// Option: Disable Floating Text
					{ 'format': 'Int8', 'key': 'thing4' },											// Option: Disable Building Glow
					{ 'format': 'Int8', 'key': 'thing5' },												// Option: Disable Manabar Glow
					{ 'format': 'Int8', 'key': 'thing6' },											// Option: Disable Treasure Glow (Holy Light)
					{ 'format': 'Int8', 'key': 'thing7' },												// Option: Disable Assistant Icon
					{ 'format': 'Int8', 'key': 'thing8' },											// Option: Disable Thousand Separator
					{ 'format': 'Int8', 'key': 'thing9' },													// Option: Disable Trophy Popups
					{ 'format': 'Int8', 'key': 'thing10' },												// Option: Sort Unpurchased Upgrades by Price
					{ 'format': 'Int8', 'key': 'thing11' },											// Option: Sort Purchased Upgrades by Price
					{ 'format': 'Int8', 'key': 'thing12' },											// Option: Multibuy Upgrade Series
					{ 'format': 'Int8', 'key': 'thing13' },											// Option: Multibuy Upgrade Series
					{ 'format': 'Int8', 'key': 'thing14' },												// Option: Don't Consolidate Upgrades
					{ 'format': 'Int8', 'key': 'thing15' },												// Option: Don't Consolidate Trophies
					{ 'format': 'Int8', 'key': 'thing16' },												// Option: Disable Premium Features
					{ 'format': 'Int8', 'key': 'thing17' },											// Option: Excavation Warning
					{ 'format': 'Int8', 'key': 'thing18' },											// Option: Exchange Warning
					{ 'format': 'Int8', 'key': 'thing19' },			
					{ 'format': 'Int8', 'key': 'thing20' },											// Option: Hide Locked/Unlocked Upgrades Separator
					{ 'format': 'Int8', 'key': 'thing21' },												// Option: Block Treasure Clicks
					{ 'format': 'Int8', 'key': 'thing22' },												// Option: Disable Spell Timer
				] },
			] };
