(function(window, document, $, undefined) {
	...
	window.SaveHandler = new function() {
		...
		var Format = new function() {
			...
			// The current Save Format (Up-to-date  game version 3.1.0.0, save format 36)
			{ this.format = [																				// Description
                ...
                { 'format': 'Int8', 'key': 'elitePrestigeFaction' },										// Third Faction ID  (13: Archon, 14: Djinn, 15: Makers)
				...
				{ 'format': 'Int32', 'key': 'fmt36val', 'cond': '_base/saveVersion >= 36' },     			// ???
				{ 'format': 'Uint32', 'key': 'dream1', 'cond': '_base/saveVersion >= 35' },
				{ 'format': 'Float64', 'key': 'dream2', 'cond': '_base/saveVersion >= 35' },
				{ 'format': 'Uint32', 'key': 'face1', 'cond': '_base/saveVersion >= 38' },
				{ 'format': 'Int32', 'key': 'face2', 'cond': '_base/saveVersion >= 38' },
				...
				{ 'format': 'Int8', 'key': 'fmt35val', 'cond': '_base/saveVersion >= 35' },
