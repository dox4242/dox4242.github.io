(function(window, document, $, undefined) {
	...
	window.SaveHandler = new function() {
		...
		var Format = new function() {
			...
			// The current Save Format (Up-to-date  game version 3.6.0.0, save format 46)
			{ this.format = [																				// Description
				...
				{ 'format': 'Array', 'key': 'catalystTargets2', 'cond': '_base/saveVersion >= 43',
					'length': { 'format': 'Int32', 'key': '_len/catalystTargets2' },
					'member': { 'format': 'Object', 'members': [
						{ 'format': 'Int8', 'key': 'targetspell2' },
					] },
				},
