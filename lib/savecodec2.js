			...
			{ this.format = [																				// Description
				...
				{ 'format': 'Array', 'key': 'buildings',													// The list of Buildings
					...
					'member': { 'format': 'Object', 'members': [
						...
						{ 'format': 'Float64', 'key': 'temp1' , 'cond': '_base/saveVersion >= 53' },		// Building: ?1 //TODO
						{ 'format': 'Float64', 'key': 'temp2' , 'cond': '_base/saveVersion >= 53' },		// Building: ?2
						{ 'format': 'Float64', 'key': 'temp3' , 'cond': '_base/saveVersion >= 53' },		// Building: ?3
						{ 'format': 'Float64', 'key': 'temp4' , 'cond': '_base/saveVersion >= 53' },		// Building: ?4
						{ 'format': 'Float64', 'key': 'temp5' , 'cond': '_base/saveVersion >= 53' },		// Building: ?5
						{ 'format': 'Float64', 'key': 'temp6' , 'cond': '_base/saveVersion >= 53' },		// Building: ?6
					] },
				},
