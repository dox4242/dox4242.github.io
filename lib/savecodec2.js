(function(window, document, $, undefined) {
	...
	window.SaveHandler = new function() {
		...
		var Format = new function() {
			...
			// The current Save Format (Up-to-date up to version 2.0.9.3)
			{ this.format = [																				// Description
				...
				{ 'format': 'Jump', 'amount': 2, 'cond': '_base/saveVersion < 13' },				{ 'format': 'Uint32', 'key': 'alignment', 'stash': '_index' },								// Index within the save format where some basic game data is stored (alignment)
				...
				{ 'format': 'Array', 'key': 'upgrades',														// The list of Upgrades
					...
					'member': { 'format': 'Object', 'members': [
						...
						{ 'format': 'Bool', 'key': 'u3', 'cond': '_base/saveVersion >= 19' },				// Upgrade: _loc29_.var_453
				...
				{ 'format': 'Array', 'key': 'trophies',														// The list of Trophies
					...
					'member': { 'format': 'Object', 'members': [
						...
						{ 'format': 'Bool', 'key': 'u1', 'cond': '_base/saveVersion >= 19' },				// Upgrade: _loc29_.var_453
					] },
				},
