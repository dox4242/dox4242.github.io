	...
	window.SaveHandler = new function() {
		...
		var Format = new function() {
			...
			{ this.format = [																				// Description
				...
				{ 'format': 'Jump', 'amount': 2 },															// Literally written as a loop with writeShort(0), running 9x
				{ 'format': 'Uint16', 'key': 'newField31' },
				...
				{ 'format': 'Int8', 'key': 'lineageFaction', 'cond': '_base/saveVersion >= 31' },	     		//
				{ 'format': 'Int8', 'key': 'newField29', 'cond': '_base/saveVersion >= 29' },					//
