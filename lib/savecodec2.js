(function(window, document, $, undefined) {
	...
	window.SaveHandler = new function() {
		...
		var Format = new function() {
			...
			// The current Save Format (Up-to-date up to version 2.6.0.0)
			{ this.format = [																				// Description
				{ 'format': 'Uint16', 'key': 'saveVersion' },												// The save format version number
				{ 'format': 'Jump', 'amount': 4 },															// Literally written as a loop with writeShort(0), running 9x
				{ 'format': 'Int16', 'key': 'newField27', 'cond': '_base/saveVersion >= 27' },
				{ 'format': 'Jump', 'amount': 2, 'cond': '_base/saveVersion < 27' },
				{ 'format': 'Int16', 'key': 'halloweenMonsters', 'cond': '_base/saveVersion >= 24' },
				{ 'format': 'Jump', 'amount': 2, 'cond': '_base/saveVersion < 24' },
				{ 'format': 'Int16', 'key': 'breathEffects', 'cond': '_base/saveVersion >= 24' },
				{ 'format': 'Jump', 'amount': 2, 'cond': '_base/saveVersion < 24' },
				...
				{ 'format': 'Array', 'key': 'spells',														// The list of Spells
					...
					'member': { 'format': 'Object', 'members': [
						...
						{ 'format': 'Uint8', 'key': 'activeTiers', 'cond': '_base/saveVersion >= 23' },				// 
				...
				{ 'format': 'Int8', 'key': 'reBuyMode', 'cond': '_base/saveVersion >= 20' },				// Excavation Multibuy button mode (0: Buy 1, 1: Buy 10, 2: Buy 100, 3: Buy All)
				...
				{ 'format': 'Object', 'key': 'options', 'members': [										// The list of options
					{ 'format': 'Int8', 'key': 'len' },														// Option: Currently active tab
					{ 'format': 'Int8', 'key': 'notation' },														// Option: Number notation (0: Short Numbers, 1: Scientific Notation, 2: Engineering Notation)
					{ 'format': 'Int8', 'key': 'thousands_sep' },												// Option: Disable Cloud Restore Warning at Setup
					{ 'format': 'Int8', 'key': 'block_bg_clicks' },											// Option: Disable Floating Text
					{ 'format': 'Int8', 'key': 'disable_upgrade_groups' },											// Option: Disable Building Glow
					{ 'format': 'Int8', 'key': 'disable_trophy_groups' },												// Option: Disable Manabar Glow
					{ 'format': 'Int8', 'key': 'sort_purchased_upgrades' },											// Option: Disable Treasure Glow (Holy Light)
					{ 'format': 'Int8', 'key': 'sort_unpurchased_upgrades' },												// Option: Disable Assistant Icon
					{ 'format': 'Int8', 'key': 'hide_purchased_upgrades' },											// Option: Disable Thousand Separator
					{ 'format': 'Int8', 'key': 'disable_tutorials' },													// Option: Disable Trophy Popups
					{ 'format': 'Int8', 'key': 'hide_unavail_research' },												// Option: Sort Unpurchased Upgrades by Price
					{ 'format': 'Int8', 'key': 'disable_buymax_button' },											// Option: Sort Purchased Upgrades by Price
					{ 'format': 'Int8', 'key': 'disable_click_particles' },											// Option: Multibuy Upgrade Series
					{ 'format': 'Int8', 'key': 'disable_click_text' },											// Option: Multibuy Upgrade Series
					{ 'format': 'Int8', 'key': 'disable_gift_of_heroes' },												// Option: Don't Consolidate Upgrades
					{ 'format': 'Int8', 'key': 'disable_gift_of_kings' },												// Option: Don't Consolidate Trophies
					{ 'format': 'Int8', 'key': 'disable_gift_of_gods' },												// Option: Disable Premium Features
					{ 'format': 'Int8', 'key': 'disable_ruby_warning' },											// Option: Excavation Warning
					{ 'format': 'Int8', 'key': 'disable_exchange_warning' },											// Option: Exchange Warning
					{ 'format': 'Int8', 'key': 'enable_extended_lists' },		
					{ 'format': 'Int8', 'key': 'disable_cloud_check' },											// Option: Hide Locked/Unlocked Upgrades Separator
					{ 'format': 'Int8', 'key': 'disable_sliding_menu' },												// Option: Block Treasure Clicks
					{ 'format': 'Int8', 'key': 'buy_all_exchanges' },												// Option: Disable Spell Timer
					{ 'format': 'Int8', 'key': 'disable_multibuy_series' },												// Option: Disable Spell Timer
					{ 'format': 'Int8', 'key': 'disable_upgrade_stacks' },												// Option: Disable Spell Timer
					{ 'format': 'Int8', 'key': 'disable_trophy_stacks' },												// Option: Disable Spell Timer
					{ 'format': 'Int8', 'key': 'disable_autoclicks' },												// Option: Disable Spell Timer
					{ 'format': 'Int8', 'key': 'spell_tooltips_persist' },												// Option: Disable Spell Timer
				] },
				{ 'format': 'Object', 'key': 'tutorials', 'members': [										// The list of options
					{ 'format': 'Int8', 'key': 'len' },														// Option: Currently active tab
					{ 'format': 'Int8', 'key': 'click_on_bg' },														// Option: Number notation (0: Short Numbers, 1: Scientific Notation, 2: Engineering Notation)
					{ 'format': 'Int8', 'key': 'buy_a_farm' },												// Option: Disable Cloud Restore Warning at Setup
					{ 'format': 'Int8', 'key': 'find_FCs_upgrades_spells' },											// Option: Disable Floating Text
					{ 'format': 'Int8', 'key': 'assistant_alignment' },											// Option: Disable Building Glow
					{ 'format': 'Int8', 'key': 'multibuy_faction_system' },												// Option: Disable Manabar Glow
					{ 'format': 'Int8', 'key': 'REs_trophies' },											// Option: Disable Treasure Glow (Holy Light)
					{ 'format': 'Int8', 'key': 'gems' },												// Option: Disable Assistant Icon
					{ 'format': 'Int8', 'key': 'buyall_upgrades_shop' },											// Option: Disable Thousand Separator
					{ 'format': 'Int8', 'key': 'archaeology' },													// Option: Disable Trophy Popups
					{ 'format': 'Int8', 'key': 'excavation_system_artifacts' },												// Option: Sort Unpurchased Upgrades by Price
					{ 'format': 'Int8', 'key': 'ruby_system' },											// Option: Sort Purchased Upgrades by Price
					{ 'format': 'Int8', 'key': 'reincs' },											// Option: Multibuy Upgrade Series
					{ 'format': 'Int8', 'key': 'reinc_power' },											// Option: Multibuy Upgrade Series
					{ 'format': 'Int8', 'key': 'challenges' },												// Option: Don't Consolidate Upgrades
					{ 'format': 'Int8', 'key': 'mercs' },												// Option: Don't Consolidate Trophies
					{ 'format': 'Int8', 'key': 'bloodlines' },												// Option: Disable Premium Features
					{ 'format': 'Int8', 'key': 'spiritual_surge' },											// Option: Excavation Warning
					{ 'format': 'Int8', 'key': 'unique_buildings1' },											// Option: Exchange Warning
					{ 'format': 'Int8', 'key': 'unique_buildings2' },			
					{ 'format': 'Int8', 'key': 'research' },											// Option: Hide Locked/Unlocked Upgrades Separator
					{ 'format': 'Int8', 'key': 'ascension1' },												// Option: Block Treasure Clicks
					{ 'format': 'Int8', 'key': 'ascension2' },												// Option: Disable Spell Timer
					{ 'format': 'Int8', 'key': 'idk1' },
					{ 'format': 'Int8', 'key': 'idk2' },
					{ 'format': 'Int8', 'key': 'idk3' },
					{ 'format': 'Int8', 'key': 'idk4' },
					{ 'format': 'Int8', 'key': 'idk5' },
					{ 'format': 'Int8', 'key': 'idk6' },
				] },
			] };
