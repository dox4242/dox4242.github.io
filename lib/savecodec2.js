(function(window, document, $, undefined) {
	...
	window.SaveHandler = new function() {
		...
		var Format = new function() {
			...
			// The current Save Format (Up-to-date up to version 2.1.0.0)
			{ this.format = [																				// Description
				{ 'format': 'Uint16', 'key': 'saveVersion' },												// The save format version number
				{ 'format': 'Jump', 'amount': 10 },															// Literally written as a loop with writeShort(0), running 9x
				...
				{ 'format': 'Array', 'key': 'spells',														// The list of Spells
					...
					'member': { 'format': 'Object', 'members': [
						...
						{ 'format': 'Int32', 'key': 'tierstat1', 'cond': '_base/saveVersion >= 22' },				// Spell: 0-based Bronze autocasting priority
						{ 'format': 'Int32', 'key': 'tierstat2', 'cond': '_base/saveVersion >= 23' },				// Spell: 0-based Bronze autocasting priority
