		...
		window.SaveHandler = new function() {
			...
			var encodeType = {
				...
				'struct': function encodeBytes(save, version) {
					...
					var newsave = {};
					var keys = {'trophies':true, 'upgrades':true};
					for (var i in save) {
			...
			var Format = new function() {
				...
				// The current Save Format (Up-to-date up to version 1.6.53.0)
				{ this.format = [																				// Description
					...
					{ 'format': 'Uint16', 'key': 'ctaFactionCasts', 'cond': '_base/saveVersion >= 13' },				// used to count for Valentine's Call to Love casting feat
					{ 'format': 'Jump', 'amount': 2, 'cond': '_base/saveVersion < 13' },
					...
					{ 'format': 'Uint32', 'key': 'artifactRngState', 'cond': '_base/saveVersion >= 4' }, 				// artifact RNG state
					{ 'format': 'Array', 'key': 'spells',														// The list of Spells
						...
						'member': { 'format': 'Object', 'members': [
							...
							{ 'format': 'Float64', 'key': 'active0', 'cond': '_base/saveVersion >= 14' }, // time active this abdication
							{ 'format': 'Float64', 'key': 'active1', 'cond': '_base/saveVersion >= 14' }, // time active prior abdications
							{ 'format': 'Float64', 'key': 'active2', 'cond': '_base/saveVersion >= 14' }, // time active prior reincarnations
					...
					{ 'format': 'Array', 'key': 'eventResources', 'cond': 'saveVersion >= 7',						// Resources for holiday events
						'length': { 'format': 'Uint16', 'key': '_len/eventResources' },
						'member': { 'format': 'Object', 'members': [
							{ 'format': 'Float64', 'key': 'eventResources' },												// unk3: First one seems to be my current snowball count
						] },
					},
					...
					{ 'format': 'Int32', 'key': 'comboStrike', 'cond': '_base/saveVersion <= 15' },						// removed in version 16, duplicated by spell cast stat
					{ 'format': 'Int32', 'key': 'comboStrikeCont' },											// combo strike streak
					{ 'format': 'Int32', 'key': 'goblinTimer' },												// Green Finger Discount
					{ 'format': 'Int32', 'key': 'wealthStorm', 'cond': '_base/saveVersion >= 11' },			// time since last Storm of Wealth bonus
					...
					{ 'format': 'Uint32', 'key': 'gameVersion' },													// import only works if <= some hardcoded value (save length upper limit check)
					...
					{ 'format': 'Object', 'key': 'options', 'members': [										// The list of options
						...
						{ 'format': 'Bool', 'key': 'disableGOTH', 'cond': '_base/saveVersion >= 12' },												// Option: Disable Premium Features
						...
						{ 'format': 'Bool', 'key': 'disableGOTK', 'cond': '_base/saveVersion >= 12' },												// Option: Disable Premium Features
						{ 'format': 'Bool', 'key': 'disableGOTG', 'cond': '_base/saveVersion >= 12' },												// Option: Disable Premium Features
						{ 'format': 'Bool', 'key': 'hideLockedResearches', 'cond': '_base/saveVersion >= 12' },												// Option: Disable Premium Features
					] },
				] };
