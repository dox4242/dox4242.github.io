...
(function(window, document, $, undefined) {
    ...
    for (var i in spec) {
      for (var j in spec[i]) {
        if (i == 'additive' || i == 'multiplicative') {
          ...
          for (var k in spec[i][j]) {
            spec[i][j][k] = spec[i][j][k].bind(self);
          }
        }
      }
    }
  ...
  function save() {
    this.lengths = {factions:13, eventResources:21, stats: 133, buildings: 25, spells: 26};
    ...
    this.event_trophy_ids = {
      ...
      // valentine's feats
      174: true, 175: true, 272: true,
      // easter feats
      191: true, 194: true, 192: true, 193: true, 287: true,
      // summer feats
    ...
    this.artifact_ids = {
      ...
      292: true, 294: true, 295: true, 296: true,
    };
    ...
    this.fc_chance_upgrades = {
      beginning: [
        [
          function (save) { return true; },
          function (save, value) { return 1; }
        ]
      ],
      additive: {/*
        // heavy coins
    ...
    build_dataflow(this.fc_chance_upgrades, this);
    ...
    this.fc_chance = function(save) {
      return this.dataflow(save, this.fc_chance_upgrades);
    }
  ...
  function assoc() {
    ...
    this.trophyIDs = [
      ...
      {id: 105115, name: 'Assistant Multiverse'},
    ...
    this.upgradeIDs = [
      ...
      {id: 174, name: 'Elf 1,1: Elven Mint'},
      {id: 175, name: 'Elf 1,2: Elven Treasure Casing'},
      {id: 177, name: 'Elf 1,3: Sylvan Treasure Frills'},
      {id: 167, name: 'Elf 2,1: Elven Emissary'},
      {id: 166, name: 'Elf 2,2: Elven Efficiency'},
      {id: 176, name: 'Elf 2,3: Secret Clicking Techniques'},
      {id: 165, name: 'Elf 3,1: Elven Diplomacy'},
      {id: 173, name: 'Elf 3,2: Elven Luck'},
      {id: 163, name: 'Elf 3,3: Ancient Clicking Arts'},
      {id: 172, name: 'Elf Heritage'},
      ...
      {id: 149, name: 'Dwarf 1,1: Dwarven Ale'},
      {id: 157, name: 'Dwarf 1,2: Expert Masonry'},
      {id: 160, name: 'Dwarf 1,3: Mining Prodigies'},
      {id: 162, name: 'Dwarf 2,1: Underground Citadels'},
      {id: 158, name: 'Dwarf 2,2: Indestrucible Treasure'},
      {id: 148, name: 'Dwarf 2,3: Bearded Assistants'},
      {id: 147, name: 'Dwarf 3,1: Battlehammers'},
      {id: 159, name: 'Dwarf 3,2: Magic Resistance'},
      {id: 161, name: 'Dwarf 3,3: Overwatch'},
      ...
      {id: 171528, name: 'E3250: Estates'},
      {id: 171629, name: 'E3300: Hirelings'},
    ...
    this.faction = [
      ...
      {
        id: 13, name: 'Archon',
        affilstat: 136, timestat: 137, upgstat: 138
      },
      {
        id: 14, name: 'Djinn',
        affilstat: 139, timestat: 140, upgstat: 141
      },
      {
        id: 15, name: 'Makers',
        affilstat: 142, timestat: 143, upgstat: 144
      }
    ];
  }
