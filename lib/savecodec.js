...
(function(window, document, $, undefined) {
  ...
  */
  ...
  var saveFormat = [                          // Description
    ...
    [ 'Empty', , 16 ],                        // Literally written as a loop with writeShort(0), running 9x
