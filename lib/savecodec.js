...
(function(window, document, $, undefined) {
  ...
  */
  ...
  var saveFormat = [                          // Description
    ...
    [ 'Empty', , 4 ],                        // Literally written as a loop with writeShort(0), running 9x
    ['Uint16', 'newField'],
    ['Uint16', 'halloweenMonsters'],
    ['Uint16', 'breathEffects'],
    ['Uint32', 'eggRngState'],
    ['Uint16', 'eggStackSize'],
    ['Uint16', 'ctaFactionCasts'],
    ...
    [ 'List', 'upgrade', 'upgradeCount', 'Uint32', [        // The list of Upgrades
      ...
      [ 'Bool', 'u4' ],                       // _loc29_.var_??? (added in RG v2)
      [ 'Uint32', 'u3' ],                     // RNG state
    ] ], 
    [ 'Uint16', 'trophyCount' ],                  // The number of Trophies
    [ 'List', 'trophy', 'trophyCount', 'Uint32', [          // The list of Trophies
      [ 'Bool', 'u1' ],                        // added in RG v2
      [ 'Uint8', 'u2' ],                        // added in save v27
    ] ], 
    [ 'Uint32', 'artifactRNGState' ],                    // V10 - possibly checksum of some kind?
    ...
    [ 'List', 'spell', 'spellCount', 'spell:Uint32', [          // The list of Spells
      ...
      [ 'Int32', , 'n3' ],                    // V10 - possibly 0-based Bronze autocasting priority
      [ 'Int32', , 'tierstat1' ],                    // 
      [ 'Uint8', , 'tierstat2' ],                    // 
      ...
      [ 'Float64', 'active0' ], // time active this abdication
      [ 'Float64', 'active1' ], // time active prior abdications
      [ 'Float64', 'active2' ], // time active prior reincarnations
      [ 'Uint32', 's' ],                      // RNG state
    ] ], 
    ...
    [ 'Uint16', 'ascension' ],                      // Current ascensions
    ...
    [ 'Float64', 'unspentRubies' ],                          // V10 - rubies that are not spent
    [ 'Float64', 'excavations' ],                          // V10 - unknown
    ...
    ['Uint16', 'extraResourcesCount'],
    ['List', 'extraResources', 'extraResourcesCount', 'Numbered', [
      ['Float64', 'amount']
    ]],                           // V10 - unknown
    ...
    ['Uint16', 'lineageLevelCount'],
    ['List', 'lineageLevels', 'lineageLevelsCount', 'Numbered', [
      ['Float64', 'amount']
    ]],
    ...
    [ 'Float64', 'oTimer2' ],                     // 
    [ 'Float64', 'oTimer3' ],                     // 
    [ 'Int8', 'season' ],                      // Season? (0: None, 1: Thanksgiving)
    [ 'Int8', 'bFaction' ],                     // 
    [ 'Int8', 'buyMode' ],                      // 
    [ 'Int8', 'lineage' ],
    [ 'Int8', 'artifactSet' ],
    [ 'Int8', 'buyMode' ],
    [ 'Int8', 'excavBuyMode' ],                      // 
    [ 'Int8', 'reBuyMode' ],                      // added in RGv2
    [ 'Int8', 'consecutiveDays' ],
    [ 'Int8', 'currentDay' ],
    [ 'Uint32', 'game_version' ],                    // (import only works if <= 18100)
    [ 'Int8', 'version_rev'], 
    [ 'List', 'options', 1, 'Numbered', [               // The list of options (out of date, cuz this codec is only used for Scribe)
      [ 'Int8', 'len' ],                      // 
      [ 'Int8', 'tab' ],                      // 
      [ 'Int8', 'thousands_sep' ],                  // 
      [ 'Int8', 'block_bg_clicks' ],                 // 
      [ 'Int8', 'disable_upgrade_groups' ],                 // 
      [ 'Int8', 'disable_trophy_groups' ],                   // 
      [ 'Int8', 'sort_purchased_upgrades' ],                 // 
      [ 'Int8', 'sort_unpurchased_upgrades' ],                  // 
      [ 'Int8', 'hide_purchased_upgrades' ],                 // 
      [ 'Int8', 'disable_tutorials' ],                    // 
      [ 'Int8', 'hide_unavail_research' ],                   // 
      [ 'Int8', 'disable_buymax_button' ],                 // 
      [ 'Int8', 'disable_click_particles' ],                 // 
      [ 'Int8', 'disable_click_text' ],                   // 
      [ 'Int8', 'disable_gift_of_heroes' ],                  // 
      [ 'Int8', 'disable_gift_of_kings' ],                  // 
      [ 'Int8', 'disable_gift_of_gods' ],                 // 
      [ 'Int8', 'disable_ruby_warning' ],                 // 
      [ 'Int8', 'disable_exchange_warning' ],                 // 
      [ 'Int8', 'enable_extended_lists' ],                // 
      [ 'Int8', 'disable_cloud_check' ],                   // 
      [ 'Int8', 'disable_sliding_menu' ],                   // 
      [ 'Int8', 'buy_all_exchanges' ],                  // 
      [ 'Int8', 'disable_multibuy_series' ],                  // 
      [ 'Int8', 'disable_upgrade_stacks' ],                  // 
      [ 'Int8', 'disable_trophy_stacks' ],                  // 
      [ 'Int8', 'disable_autoclicks' ],                  // 
    ] ],
    [ 'List', 'tutorials', 1, 'Numbered', [               // 
      [ 'Int8', 'len' ],                      // 
      [ 'Int8', 'click_on_bg' ],                      // 
      [ 'Int8', 'buy_a_farm' ],                  // 
      [ 'Int8', 'find_FCs_upgrades_spells' ],                 // 
      [ 'Int8', 'assistant_alignment' ],                 // 
      [ 'Int8', 'multibuy_faction_system' ],                   // 
      [ 'Int8', 'REs_trophies' ],                 // 
      [ 'Int8', 'gems' ],                  // 
      [ 'Int8', 'buyall_upgrades_shop' ],                 // 
      [ 'Int8', 'archaeology' ],                    // 
      [ 'Int8', 'excavation_system_artifacts' ],                   // 
      [ 'Int8', 'ruby_system' ],                 // 
      [ 'Int8', 'reincs' ],                 // 
      [ 'Int8', 'reinc_power' ],                   // 
      [ 'Int8', 'challenges' ],                  // 
      [ 'Int8', 'mercs' ],                  // 
      [ 'Int8', 'bloodlines' ],                 // 
      [ 'Int8', 'spiritual_surge' ],                 // 
      [ 'Int8', 'unique_buildings1' ],                 // 
      [ 'Int8', 'unique_buildings2' ],                // 
      [ 'Int8', 'research' ],                   // 
      [ 'Int8', 'ascension1' ],                   // 
      [ 'Int8', 'ascension2' ],                  // 
      [ 'Int8', 'new1' ],                   // 
      ...
      [ 'Int8', 'new4' ],                   // 
      [ 'Int8', 'new5' ],                   // 
      [ 'Int8', 'new6' ],                   // lineage update
      [ 'Int8', 'new7' ],                   // lineage update
    ] ]
  ];
